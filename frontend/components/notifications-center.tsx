  ...
  return (
    <div className={cn("relative", className)}>
      ...
      {open ? (
        <div
          ref={panelRef}
          className="fixed inset-x-3 top-16 z-[60] flex w-auto max-h-[calc(100dvh-8.5rem-env(safe-area-inset-bottom))] flex-col overflow-hidden rounded-xl border border-zinc-200 bg-white shadow-xl md:absolute md:inset-x-auto md:right-0 md:top-full md:mt-2 md:w-[min(calc(100vw-2rem),22rem)] md:max-h-[min(70vh,32rem)] dark:border-zinc-800 dark:bg-zinc-950"
          role="dialog"
          aria-modal="false"
